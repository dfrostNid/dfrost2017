/*! infiniteimaginations 2017-01-30 */
...
function () {
	function p(b, a, d) {
		return ("string" == typeof a ? a : a.toString()).replace(b.define || h, function (a, c, e, g) {
			return 0 === c.indexOf("def.") && (c = c.substring(4)), c in d || (":" === e ? (b.defineParams && g.replace(b.defineParams, function (a, b, l) {
				d[c] = {
					arg: b,
					text: l
				}
	...
	f.template = function (b, a, d) {
		...
		var c, g, n = a.append ? r : s,
			e = 0;
		b = a.use || a.define ? p(a, b, d || {}) : b, b = ("var out='" + (a.strip ? b.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : b).replace(/'|\\/g, "\\$&").replace(a.interpolate || h, function (b, a) {
			return n.start + k(a) + n.end
		}).replace(a.encode || h, function (b, a) {
			return c = !0, n.startencode + k(a) + n.end
			...
			return a ? (e += 1, g = d || "i" + e, a = k(a), "';var arr" + e + "=" + a + ";if(arr" + e + "){var " + c + "," + g + "=-1,l" + e + "=arr" + e + ".length-1;while(" + g + "<l" + e + "){" + c + "=arr" + e + "[" + g + "+=1];out+='") : "';} } out+='"
		}).replace(a.evaluate || h, function (a, b) {
			return "';" + k(b) + "out+='"
		}) + "';return out;").replace(/\n/g, "\\n").replace(/\t/g, "\\t").replace(/\r/g, "\\r").replace(/(\s|;|\}|^|\{)out\+='';/g, "$1").replace(/\+''/g, ""), c && (a.selfcontained || !m || m._encodeHTML || (m._encodeHTML = f.encodeHTMLSource(a.doNotSkipEncoded)), b = "var encodeHTML = typeof _encodeHTML !== 'undefined' ? _encodeHTML : (" + f.encodeHTMLSource.toString() + "(" + (a.doNotSkipEncoded || "") + "));" + b);
		try {
	...
	function f(e, t, r, o) {
		...
		return i = s("style"), i.type = "text/css", i.id = "s" + c, (d.fake ? d : p).appendChild(i), d.appendChild(p), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(n.createTextNode(e)), p.id = c, d.fake && (d.style.background = "", d.style.overflow = "hidden", l = _.style.overflow, _.style.overflow = "hidden", _.appendChild(d)), f = t(p, e), d.fake ? (d.parentNode.removeChild(d), _.style.overflow = l, _.offsetHeight) : p.parentNode.removeChild(p), !!f
	}
	...
	function v(e, n, o, i) {
		...
		for (var c, p, d, v, h, y = ["modernizr", "tspan", "samp"]; !N.style && y.length;) c = !0, N.modElem = s(y.shift()), N.style = N.modElem.style;
		for (d = e.length, p = 0; d > p; p++)
			if (v = e[p], h = N.style[v], l(v, "-") && (v = u(v)), N.style[v] !== t) {
				if (i || r(o, "undefined")) return a(), "pfx" != n || v;
				try {
					N.style[v] = o
				} catch (g) {}
	...
	function h(e, n, t, o, i) {
		...
		return r(n, "string") || r(n, "undefined") ? v(a, n, o, i) : (a = (e + " " + E.join(s + " ") + s).split(" "), p(a, n, t))
	}
	var y = [],
		g = [],
		C = {
	...
	var z = "Moz O ms Webkit",
		j = C._config.usePrefixes ? z.split(" ") : [];
	C._cssomPrefixes = j;
	var T = function (n) {
		var r, o = w.length,
			i = e.CSSRule;
	...
	C.atRule = T;
	var E = C._config.usePrefixes ? z.toLowerCase().split(" ") : [];
	C._domPrefixes = E;
	var P = {
		elem: s("modernizr")
	};
	...
	var k = C.prefixed = function (e, n, t) {
		return 0 === e.indexOf("@") ? T(e) : (-1 != e.indexOf("-") && (e = u(e)), n ? h(e, n, t) : h(e, "pfx"))
	};
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
		...
		_gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function (t, e, i) {
			...
			return l.constructor = s, l.kill()._gc = !1, s.version = "1.18.0", l.invalidate = function () {
				...
				if (!(this._time !== p && this._first || i || _ || c)) return void(d !== this._totalTime && this._onUpdate && (e || this._callback("onUpdate")));
			...
			return s.version = "1.18.0", d.constructor = s, d.kill()._gc = d._forcingPlayhead = d._hasPause = !1, d.to = function (t, e, s, r) {
				...
				if (this._time !== f && this._first || i || h || u) {
					...
					this._onUpdate && (e || (l.length && _(), this._callback("onUpdate"))), o && (this._gc || (m === this._startTime || p !== this._timeScale) && (0 === this._time || c >= this.totalDuration()) && (n && (l.length && _(), this._timeline.autoRemoveChildren && this._enabled(!1, !1),
			...
			function () {
				var t = 180 / Math.PI,
					...
					l = function (t, e, i, s) {
						var r = {
							...
							c = (h + _) / 2,
							f = (c - u) / 8;
						return r.b = l + (t - l) / 4, n.b = u + f, r.c = n.a = (r.b + n.b) / 2, n.c = a.a = (u + c) / 2, a.b = c - f, o.b = _ + (s - _) / 4,
						...
						e._registerComplexSpecialProp("bezier", {
							parser: function (t, e, n, a, o, l) {
								...
								return d.values = p, o = new r(t, "bezier", 0, 0, u.pt, 2), o.data = u, o.plugin = l, o.setRatio = s, 0 === d.autoRotate && (d.autoRotate = !0), !d.autoRotate || d.autoRotate instanceof Array || (h = d.autoRotate === !0 ? 0 : Number(d.autoRotate), d.autoRotate = null != u.end.left ? [
									...
									["x", "y", "rotation", h, !1]
								]), d.autoRotate && (a._transform || a._enableTransforms(!1), u.autoRotate = a._target._gsTransform), l._onInitTween(u.proxy, d, a._tween), o
							}
						})
					}
				...
				var _, u, c, f, p, m, d = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
					...
					Y = function () {
						var t = j.indexOf("Android"),
							e = N("a");
						return c = -1 !== j.indexOf("Safari") && -1 === j.indexOf("Chrome") && (-1 === t || Number(j.substr(t + 8, 1)) > 3), p = c && 6 > Number(j.substr(j.indexOf("Version/") + 8, 1)), f = -1 !== j.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(j) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(j)) && (m = parseFloat(RegExp.$1)), !!e && (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity))
					}(),
					U = function (t) {
				...
				var we, be = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
					...
					Oe = B.Transform = function () {
						this.perspective = parseFloat(a.defaultTransformPerspective) || 0, this.force3D = !(a.defaultForce3D === !1 || !Re) && (a.defaultForce3D || "auto")
					},
	...
	function (t, e) {
		...
		if (!i.TweenLite) {
			...
			var D = g("TweenLite", function (e, i, s) {
				...
				z = function (t, e) {
					var i, s = {};
					for (i in t) q[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!j[i] || j[i] && j[i]._autoCSS) || (s[i] = t[i],
						delete t[i]);
					t.css = s
				};
		...
		CountTo.DEFAULTS = {
			...
			return this.each(function () {
				var $this = $(this),
					...
					init = !data || "object" == typeof option,
					options = "object" == typeof option ? option : {},
					method = "string" == typeof option ? option : "start";
...
var Path = {
	version: "0.8.4",
	map: function (path) {
		return Path.routes.defined.hasOwnProperty(path) ? Path.routes.defined[path] : new Path.core.route(path)
	},
	root: function (path) {
	...
	history: {
		...
		pushState: function (state, title, path) {
			Path.history.supported ? Path.dispatch(path) && history.pushState(state, title, path) : Path.history.fallback && (window.location.hash = "#" + path)
		},
		popState: function (event) {
			var initialPop = !Path.history.initial.popped && location.href == Path.history.initial.URL;
			Path.history.initial.popped = !0, initialPop || Path.dispatch(document.location.pathname)
		},
		listen: function (fallback) {
			if (Path.history.supported = !(!window.history || !window.history.pushState), Path.history.fallback = fallback, Path.history.supported) Path.history.initial.popped = "state" in window.history, Path.history.initial.URL = location.href, window.onpopstate = Path.history.popState;
	...
	match: function (path, parameterize) {
		var possible_routes, slice, i, j, compare, params = {},
			route = null;
		for (route in Path.routes.defined)
			if (null !== route && void 0 !== route)
				for (route = Path.routes.defined[route], possible_routes = route.partition(), j = 0; j < possible_routes.length; j++) {
					if (slice = possible_routes[j], compare = path, slice.search(/:/) > 0)
						for (i = 0; i < slice.split("/").length; i++) i < compare.split("/").length && ":" === slice.split("/")[i].charAt(0) && (params[slice.split("/")[i].replace(/:/, "")] = compare.split("/")[i], compare = compare.replace(compare.split("/")[i], slice.split("/")[i]));
					if (slice === compare) return parameterize && (route.params = params), route
				}
			return null
	},
	dispatch: function (passed_route) {
		...
		if (Path.routes.current !== passed_route) {
			if (Path.routes.previous = Path.routes.current, Path.routes.current = passed_route, matched_route = Path.match(passed_route, !0), Path.routes.previous && (previous_route = Path.match(Path.routes.previous), null !== previous_route && null !== previous_route.do_exit && previous_route.do_exit()), null !== matched_route) return matched_route.run(), !0;
	...
	listen: function () {
		...
		"" === location.hash && null !== Path.routes.root && (location.hash = Path.routes.root), "onhashchange" in window && (!document.documentMode || document.documentMode >= 8) ? window.onhashchange = fn : setInterval(fn, 50), "" !== location.hash && Path.dispatch(location.hash)
	},
	core: {
		route: function (path) {
			this.path = path, this.action = null, this.do_enter = [], this.do_exit = null, this.params = {}, Path.routes.defined[path] = this
		}
	},
	routes: {
		current: null,
...
Path.core.route.prototype = {
		to: function (fn) {
			return this.action = fn, this
		},
		enter: function (fns) {
			return fns instanceof Array ? this.do_enter = this.do_enter.concat(fns) : this.do_enter.push(fns), this
		},
		exit: function (fn) {
			return this.do_exit = fn, this
		},
		partition: function () {
			for (var text, i, parts = [], options = [], re = /\(([^}]+?)\)/g; text = re.exec(this.path);) parts.push(text[1]);
			for (options.push(this.path.split("(")[0]), i = 0; i < parts.length; i++) options.push(options[options.length - 1] + parts[i]);
			return options
		},
		run: function () {
			var i, result, halt_execution = !1;
			if (Path.routes.defined[this.path].hasOwnProperty("do_enter") && Path.routes.defined[this.path].do_enter.length > 0)
				for (i = 0; i < Path.routes.defined[this.path].do_enter.length; i++)
					if (result = Path.routes.defined[this.path].do_enter[i].apply(this, null), result === !1) {
						halt_execution = !0;
						break
					}
			halt_execution || Path.routes.defined[this.path].action()
		}
	},
	function (factory) {
		"undefined" != typeof define && define.amd ? define([], factory) : "undefined" != typeof module && module.exports ? module.exports = factory() : window.scrollMonitor = factory()
	}(function () {
		function calculateViewport() {
			if (exports.viewportTop = scrollTop(), exports.viewportBottom = exports.viewportTop + exports.viewportHeight, exports.documentHeight = getDocumentHeight(), exports.documentHeight !== previousDocumentHeight) {
				for (calculateViewportI = watchers.length; calculateViewportI--;) watchers[calculateViewportI].recalculateLocation();
				previousDocumentHeight = exports.documentHeight
			}
		}

		function recalculateWatchLocationsAndTrigger() {
			exports.viewportHeight = getViewportHeight(), calculateViewport(), updateAndTriggerWatchers()
		}

		function debouncedRecalcuateAndTrigger() {
			clearTimeout(recalculateAndTriggerTimer), recalculateAndTriggerTimer = setTimeout(recalculateWatchLocationsAndTrigger, 100)
		}

		function updateAndTriggerWatchers() {
			for (updateAndTriggerWatchersI = watchers.length; updateAndTriggerWatchersI--;) watchers[updateAndTriggerWatchersI].update();
			for (updateAndTriggerWatchersI = watchers.length; updateAndTriggerWatchersI--;) watchers[updateAndTriggerWatchersI].triggerCallbacks()
		}

		function ElementWatcher(watchItem, offsets) {
			function triggerCallbackArray(listeners) {
				if (0 !== listeners.length)
					for (listenerToTriggerListI = listeners.length; listenerToTriggerListI--;) listener = listeners[listenerToTriggerListI], listener.callback.call(self, latestEvent), listener.isOne && listeners.splice(listenerToTriggerListI, 1)
			}
			var self = this;
			this.watchItem = watchItem, offsets ? offsets === +offsets ? this.offsets = {
				top: offsets,
				bottom: offsets
			} : this.offsets = {
				top: offsets.top || defaultOffsets.top,
				bottom: offsets.bottom || defaultOffsets.bottom
			} : this.offsets = defaultOffsets, this.callbacks = {};
			for (var i = 0, j = eventTypes.length; i < j; i++) self.callbacks[eventTypes[i]] = [];
			this.locked = !1;
			var wasInViewport, wasFullyInViewport, wasAboveViewport, wasBelowViewport, listenerToTriggerListI, listener;
			this.triggerCallbacks = function () {
				switch (this.isInViewport && !wasInViewport && triggerCallbackArray(this.callbacks[ENTERVIEWPORT]), this.isFullyInViewport && !wasFullyInViewport && triggerCallbackArray(this.callbacks[FULLYENTERVIEWPORT]), this.isAboveViewport !== wasAboveViewport && this.isBelowViewport !== wasBelowViewport && (triggerCallbackArray(this.callbacks[VISIBILITYCHANGE]), wasFullyInViewport || this.isFullyInViewport || (triggerCallbackArray(this.callbacks[FULLYENTERVIEWPORT]), triggerCallbackArray(this.callbacks[PARTIALLYEXITVIEWPORT])), wasInViewport || this.isInViewport || (triggerCallbackArray(this.callbacks[ENTERVIEWPORT]), triggerCallbackArray(this.callbacks[EXITVIEWPORT]))), !this.isFullyInViewport && wasFullyInViewport && triggerCallbackArray(this.callbacks[PARTIALLYEXITVIEWPORT]), !this.isInViewport && wasInViewport && triggerCallbackArray(this.callbacks[EXITVIEWPORT]), this.isInViewport !== wasInViewport && triggerCallbackArray(this.callbacks[VISIBILITYCHANGE]), !0) {
				...
				wasInViewport = this.isInViewport, wasFullyInViewport = this.isFullyInViewport, wasAboveViewport = this.isAboveViewport, wasBelowViewport = this.isBelowViewport
			}, this.recalculateLocation = function () {
				if (!this.locked) {
					var previousTop = this.top,
						previousBottom = this.bottom;
					if (this.watchItem.nodeName) {
						var cachedDisplay = this.watchItem.style.display;
						"none" === cachedDisplay && (this.watchItem.style.display = "");
						var boundingRect = this.watchItem.getBoundingClientRect();
						this.top = boundingRect.top + exports.viewportTop, this.bottom = boundingRect.bottom + exports.viewportTop, "none" === cachedDisplay && (this.watchItem.style.display = cachedDisplay)
					} else this.watchItem === +this.watchItem ? this.watchItem > 0 ? this.top = this.bottom = this.watchItem : this.top = this.bottom = exports.documentHeight - this.watchItem : (this.top = this.watchItem.top, this.bottom = this.watchItem.bottom);
					this.top -= this.offsets.top, this.bottom += this.offsets.bottom, this.height = this.bottom - this.top, void 0 === previousTop && void 0 === previousBottom || this.top === previousTop && this.bottom === previousBottom || triggerCallbackArray(this.callbacks[LOCATIONCHANGE])
				}
			}, this.recalculateLocation(), this.update(), wasInViewport = this.isInViewport, wasFullyInViewport = this.isFullyInViewport, wasAboveViewport = this.isAboveViewport, wasBelowViewport = this.isBelowViewport
		}

		function scrollMonitorListener(event) {
			latestEvent = event, calculateViewport(), updateAndTriggerWatchers()
		}
		var scrollTop = function () {
			...
			eventTypes = [VISIBILITYCHANGE, ENTERVIEWPORT, FULLYENTERVIEWPORT, EXITVIEWPORT, PARTIALLYEXITVIEWPORT, LOCATIONCHANGE, STATECHANGE],
			defaultOffsets = {
				top: 0,
				bottom: 0
			},
		...
		var previousDocumentHeight, latestEvent, calculateViewportI, recalculateAndTriggerTimer, updateAndTriggerWatchersI;
		ElementWatcher.prototype = {
			on: function (event, callback, isOne) {
				switch (!0) {
					...
					case event === PARTIALLYEXITVIEWPORT && this.isAboveViewport:
						if (callback.call(this, latestEvent), isOne) return
				}
				if (!this.callbacks[event]) throw new Error("Tried to add a scroll monitor listener of type " + event + ". Your options are: " + eventTypes.join(", "));
			...
			off: function (event, callback) {
				if (!this.callbacks[event]) throw new Error("Tried to remove a scroll monitor listener of type " + event + ". Your options are: " + eventTypes.join(", "));
				for (var item, i = 0; item = this.callbacks[event][i]; i++)
			...
			one: function (event, callback) {
				this.on(event, callback, !0)
			},
			recalculateSize: function () {
				this.height = this.watchItem.offsetHeight + this.offsets.top + this.offsets.bottom, this.bottom = this.top + this.height
			},
			update: function () {
				this.isAboveViewport = this.top < exports.viewportTop, this.isBelowViewport = this.bottom > exports.viewportBottom, this.isInViewport = this.top <= exports.viewportBottom && this.bottom >= exports.viewportTop, this.isFullyInViewport = this.top >= exports.viewportTop && this.bottom <= exports.viewportBottom || this.isAboveViewport && this.isBelowViewport
			},
			destroy: function () {
				var index = watchers.indexOf(this),
					self = this;
				watchers.splice(index, 1);
				for (var i = 0, j = eventTypes.length; i < j; i++) self.callbacks[eventTypes[i]].length = 0
			},
			lock: function () {
				this.locked = !0
			},
		...
		for (var eventHandlerFactory = function (type) {
				return function (callback, isOne) {
					this.on.call(this, type, callback, isOne)
				}
			}, i = 0, j = eventTypes.length; i < j; i++) {
		...
		return window.addEventListener ? (window.addEventListener("scroll", scrollMonitorListener), window.addEventListener("resize", debouncedRecalcuateAndTrigger)) : (window.attachEvent("onscroll", scrollMonitorListener), window.attachEvent("onresize", debouncedRecalcuateAndTrigger)), exports.beget = exports.create = function (element, offsets) {
			"string" == typeof element ? element = document.querySelector(element) : element && element.length > 0 && (element = element[0]);
			var watcher = new ElementWatcher(element, offsets);
			return watchers.push(watcher), watcher.update(), watcher
		}, exports.update = function () {
			latestEvent = null, calculateViewport(), updateAndTriggerWatchers()
		}, exports.recalculateLocations = function () {
			exports.documentHeight = 0, exports.update()
		}, exports
	});
var RR = function (parent, $) {
	...
	var setup = function () {
		...
		gaClickEvent = function (c, l) {
			ga("send", "event", c, "click", l)
		};
	return parent.gaListeners = {
		setup: setup,
...
var RR = function (parent, $) {
	...
	var setup = function () {
		Path.root("#/hello/"), Path.map("#/hello/").enter(updateAnalytics).to(function () {
			RR.listeners.exitCurrentSlide("hello"), RR.listeners.setActiveNav("hello")
		}), Path.map("#/about/").enter(updateAnalytics).to(function () {
			RR.listeners.exitCurrentSlide("about"), RR.listeners.setActiveNav("about")
		}), Path.map("#/achievements/").enter(updateAnalytics).to(function () {
			RR.listeners.exitCurrentSlide("achievements"), RR.listeners.setActiveNav("achievements")
		}), Path.map("#/coding/").enter(updateAnalytics).to(function () {
			RR.listeners.exitCurrentSlide("coding"), RR.listeners.setActiveNav("coding")
		}), Path.map("#/design/").enter(updateAnalytics).to(function () {
			RR.listeners.exitCurrentSlide("design"), RR.listeners.setActiveNav("design")
		}), Path.map("#/design/").enter(updateAnalytics).to(function () {
			RR.listeners.exitCurrentSlide("design"), RR.listeners.setActiveNav("design")
			...
			RR.listeners.exitCurrentSlide("contact"), RR.listeners.setActiveNav("contact")
...
var RR = function (parent, $) {
	...
	function createCaseStudyScrollMonitor() {
		$(".case-study__section").each(function (i, el) {
			var $this = $(el);
			caseStudyWatcher = scrollMonitor.create(el, -100), caseStudyWatcher.enterViewport(function () {
				TweenMax.to($this.find("h2"), .5, {
					opacity: 1,
					y: 0,
					ease: Expo.easeOut
				}), TweenMax.staggerTo($this.find(".col"), .5, {
					opacity: 1,
					y: 0,
					ease: Expo.easeOut
				}, .1), TweenMax.staggerTo($this.find("h3"), .5, {
					opacity: 1,
					y: 0,
					ease: Expo.easeOut,
					delay: .1
				}, .1), TweenMax.to($this.find("hr"), .5, {
					width: "100%",
					ease: Expo.easeOut,
					delay: .2
				}), TweenMax.to($this.find(".pattern"), .5, {
					width: "100%",
					ease: Expo.easeOut,
					delay: .3
				}), TweenMax.staggerTo($this.find("p"), .5, {
					opacity: 1,
					y: 0,
					ease: Expo.easeOut,
					delay: .4
				}, .1), TweenMax.staggerTo($this.find("li"), .5, {
					opacity: 1,
					y: 0,
					ease: Expo.easeOut,
					delay: .5
				}, .1), TweenMax.to($this.find(".cta"), .5, {
					opacity: 1,
					y: 0,
					ease: Expo.easeOut,
					delay: .6
	...
	function populateData(json) {
		var nthChild;
		$(".coding"), $(".design");
		caseStudies = json.caseStudies, $(".card-link").each(function (i, v) {
			var $this = $(this);
			nthChild = 0 == i || i < 3 ? i + 1 : i + 1 - 3, $this.attr("href", caseStudies[i].url.local), $this.data("original", caseStudies[i].images.small), $this.find("img").attr("src", caseStudies[i].images.small), $this.find("img").attr("alt", caseStudies[i].title), $this.find(".card-title").text(caseStudies[i].title)
		}).on("click", function () {
	...
	function setData(ind) {
		var caseStudyTemp = ($(".case-study"), doT.template($("#case-study-template").html())),
			obj = {};
		void 0 == caseStudies[ind] ? setTimeout(function () {
			setData(ind)
		}, 1e3) : (nextInd = ind + 1 == caseStudies.length ? 0 : ind + 1, caseStudyItem = caseStudies[ind], nextCaseStudyItem = caseStudies[nextInd], obj = {
		...
		}, $(".primary-nav .active").removeClass("active"), $('.primary-nav a[data-name="' + caseStudyItem.category + '"]').addClass("active"), $(".case-study__wrap").html(caseStudyTemp(obj)))
	}

	function switchSlide($url) {
		$("." + currentPage).hide(), "" == $url ? $url = "hello" : $("." + $url).length || ($url = "404"), "404" == $url && ($url = "error"), $("." + $url).show().find("h1 .text").html(" ");
		var $gotoElem = $("." + $url + " h1");
		TweenMax.to(".element-clone", syncTime, {
			...
			boxShadow: "0",
			ease: Expo.easeInOut
		}), "case-study" == $url ? (document.body.scrollTop = document.documentElement.scrollTop = 0, $header.removeClass("dark hide shadow-z2")) : TweenMax.to(window, syncTime, {
			scrollTo: {
				y: 0
			},
			ease: Expo.easeInOut,
			...
			ease: Expo.easeInOut,
			onComplete: function () {
				switch ($(".element-clone").remove(), resetSlide(currentPage), "hello" !== $url && TweenMax.set("." + $url + " h1", {
	...
	function resetSlide(slide) {
		switch (TweenMax.set("." + slide, {
			...
			opacity: 0,
			y: 50
		}), $("." + slide + " .text").removeClass("glitch"), slide) {
			case "about":
				...
				break;
			case "achievements":
				$(".achievements .nominations li").removeClass("init"), TweenMax.set(".achievements .col-l a", {
					opacity: 0,
					y: 50
	...
	function enterHello() {
		$(".hello h1 .text").html(" "), TweenMax.to(".hello h1", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bHello.start().reveal(750, 750), $(".hello h1 .text").addClass("glitch")
			}
	...
	function enterAbout() {
		TweenMax.to(".about .bar", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bAbout.start().reveal(750, 750), $(".about h1 .text").addClass("glitch")
			}
			...
			ease: Expo.easeOut,
			delay: .1
		}), isMobile() ? (skillsWatcher.enterViewport(function () {
			TweenMax.to(".about h2", .5, {
				...
				}, 250 * i), TweenMax.to($this, .75, {
					width: $percent + "%",
					ease: Expo.easeInOut,
					delay: .25 * i
				}), TweenMax.to($this.find(".skills__label"), .75, {
					opacity: 1,
					ease: Expo.easeInOut,
					delay: .25 * i,
					onStart: function () {
			...
			$(".skills__bar").each(function (i) {
				...
				setTimeout(function () {
					...
					ease: Expo.easeInOut,
					delay: .1 * i
				}), TweenMax.to($this.find(".skills__label"), .5, {
					opacity: 1,
					ease: Expo.easeInOut,
					delay: .1 * i,
					onStart: function () {
	...
	function enterAchievements() {
		TweenMax.to(".achievements .bar", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bAchievements.start().reveal(750, 750), $(".achievements h1 .text").addClass("glitch")
			}
			...
			ease: Expo.easeOut,
			delay: .2
		}), isMobile() ? (nominationsWatcher.enterViewport(function () {
	...
	function enterCoding() {
		TweenMax.to(".coding .bar", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bCoding.start().reveal(750, 750), $(".coding h1 .text").addClass("glitch")
			}
	...
	function enterDesign() {
		TweenMax.to(".design .bar", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bDesign.start().reveal(750, 750), $(".design h1 .text").addClass("glitch")
			}
	...
	function enterCaseStudy() {
		createCaseStudyScrollMonitor(), TweenMax.to(".case-study .bar", .5, {
			width: "100%",
			ease: Expo.easeOut,
			onComplete: function () {
				bCaseStudy.text(function () {
					return "// case study: " + caseStudyItem.title
				}).start().reveal(750, 750), $(".case-study h1 .text").addClass("glitch"), caseStudyWatcher.recalculateLocation()
			}
	...
	function enterContact() {
		TweenMax.to(".contact .bar", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bContact.start().reveal(750, 750), $(".contact h1 .text").addClass("glitch")
			}
	...
	function enterError() {
		TweenMax.to(".error .bar", .5, {
			...
			ease: Expo.easeOut,
			onComplete: function () {
				bError.start().reveal(750, 750), $(".error h1 .text").addClass("glitch")
			}
	...
	var bHello, bAbout, bAchievements, bCoding, bDesign, bContact, bCaseStudy, bError, skillsWatcher, logosWatcher, ribbonsWatcher, nominationsWatcher, caseStudyWatcher, caseStudyItem, nextCaseStudyItem, ind, $window = ($(document), $(window)),
		$header = $(".header"),
		currentPage = "hello",
		$data = "hello",
		syncTime = .5,
		...
		setup = function () {
			TweenMax.to(".logo", .5, {
				...
				ease: Expo.easeOut,
				delay: .75
			}), isDesktop() && $(".hello nav a, .primary-nav a").on("mouseover", function (e) {
				e.preventDefault(), TweenMax.to($(this).find(".text"), .25, {
					autoAlpha: 0,
					scale: 1.5,
					ease: Expo.easeOut
				})
				...
				var $this = $(this);
				return $data = $this.data("name"), $data != currentPage && ($("body").append('<div class="element-clone" style="height: ' + $this.outerHeight() + "px; width: " + $this.outerWidth() + 'px;"/>'), $this.clone().appendTo(".element-clone"), TweenMax.set(".element-clone", {
					left: $this.offset().left,
					top: $this.offset().top,
					boxShadow: "0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23)"
				}), void($this.closest(".primary-nav").length ? ($(".header .menu").trigger("click"), setTimeout(function () {
					RR.menu.tlHoverReverse()
				}, 500), RR.gaListeners.gaClickEvent("Menu: Nav", $data)) : RR.gaListeners.gaClickEvent("Hello: Nav", $data)))
			}), $(".header .logo a").on("click", function () {
				$data = "hello", RR.gaListeners.gaClickEvent("Logo", null)
				...
				$(this).find("span").length ? RR.gaListeners.gaClickEvent("Next", $(this).find(".navigation-label span").text()) : RR.gaListeners.gaClickEvent("Next", $(this).find(".navigation-label").text())
			}), $(".contact-icons a").click(function () {
				RR.gaListeners.gaClickEvent("Contact", $(this).find(".vh").text())
			}), skillsWatcher = scrollMonitor.create(document.getElementsByClassName("skills"), -100), logosWatcher = scrollMonitor.create(document.getElementsByClassName("logos"), -100), ribbonsWatcher = scrollMonitor.create(document.getElementsByClassName("ribbons"), -100), nominationsWatcher = scrollMonitor.create(document.getElementsByClassName("nominations"), -100), createCaseStudyScrollMonitor(), bHello = baffle(".hello h1 .text", {
				characters: "█▓▒░",
				speed: 40
				...
				bSkillsLabel.push(baffle(".skills__bar:nth-child(" + (i + 1) + ") .skills__label", {
					characters: "█▓▒░",
					speed: 40
				}))
			}), $.ajax({
			...
			$window.on("scroll", function () {
				st = $(this).scrollTop(), $headerHeight = $header.height(), st > lastScrollTop ? document.body.scrollTop >= 20 && $header.addClass("dark hide shadow-z2") : st <= $headerHeight ? $header.removeClass("dark shadow-z2") : $header.removeClass("hide"), lastScrollTop = st
			})
		},
		...
		exitCurrentSlide = function ($url) {
			"case-study" != currentPage && (TweenMax.to("." + currentPage + " h1", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut
			}), TweenMax.to("." + currentPage + " p", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .1
			}), TweenMax.to("." + currentPage + " h2", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .1
			}), TweenMax.to("." + currentPage + " hr", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2
			})), "hello" == currentPage ? TweenMax.staggerTo(".hello li", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2,
				...
				switchSlide($url)
			}) : "about" == currentPage ? (TweenMax.staggerTo(".skills__bar", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2,
				...
				switchSlide($url)
			})) : "achievements" == currentPage ? (TweenMax.staggerTo(".nominations li", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2
				...
				switchSlide($url)
			})) : "coding" == currentPage ? TweenMax.staggerTo(".coding .card", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2,
				...
				switchSlide($url)
			}) : "design" == currentPage ? TweenMax.staggerTo(".design .card", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2,
				...
				switchSlide($url)
			}) : "case-study" == currentPage ? (destroyCaseStudyScrollMonitor(), TweenMax.to(".case-study", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .2,
			...
			})) : "contact" == currentPage ? TweenMax.staggerTo(".contact-icons li", .5, {
				opacity: 0,
				y: -50,
				ease: Expo.easeInOut,
				delay: .3,
				...
				switchSlide($url)
			}) : "error" == currentPage && TweenMax.to("element", .5, {
				delay: .2,
				onComplete: function () {
					switchSlide($url)
				}
		...
		setActiveNav = function (navEl) {
			$(".primary-nav").find(".active").removeClass("active").end().find(".element-box[data-name=" + navEl + "]").addClass("active")
		},
		isMobile = function () {
...
var RR = function (parent, $) {
	"use strict";
	var setup = ($("body"), $(window), function () {
			var $rippleEffect = $("button, .cta");
			$rippleEffect.on("click", function (e) {
				var $this = $(this);
				$this.hasClass("disabled") || ripple(e, $this)
			});
			var $materialMenu = $(".material-menu"),
				tl = new TimelineMax;
			tl.to(".material-menu .top", .2, {
				top: 4,
				ease: Expo.easeInOut
			}), tl.to(".material-menu .bot", .2, {
				top: -4,
				ease: Expo.easeInOut
			}, "-=0.2"), tl.to(".material-menu .mid", .2, {
				opacity: 0,
				ease: Expo.easeInOut
			}), tl.to(".material-menu .top", .2, {
				rotation: 45,
				ease: Expo.easeInOut
			}, "-=0.2"), tl.to(".material-menu .bot", .2, {
				rotation: -45,
				ease: Expo.easeInOut
			}, "-=0.2"), tl.pause(), $materialMenu.on("click", function () {
				var $this = $(this);
				$this.toggleClass("active"), $this.hasClass("active") ? tl.reverse() : tl.play()
				...
				}), void 0 !== $this.data("hint") && "" !== $this.data("hint") && $this.after('<span class="hint"><strong>*Hint: </strong>' + $this.data("hint") + "</span>"), $(".placeholder").on("click", function () {
					$(this).next().focus()
				})
			})
		}),
		toasterInd = 0,
		toaster = function (msg) {
			var popupAlert = doT.template($("#toaster-template").html()),
				obj = {
					ind: toasterInd,
					message: msg
				};
			$(".toaster-wrap").length || $("#main").after('<div class="toaster-wrap" />'), $(".toaster-wrap").append(popupAlert(obj));
			var toaster = ".toaster" + toasterInd;
			TweenMax.to(toaster, .75, {
				scale: 1,
				ease: Expo.easeOut
			}), TweenMax.to(toaster, .75, {
				scale: .75,
				...
				e.preventDefault(), TweenMax.to($(this), .75, {
					scale: 0,
					ease: Expo.easeOut,
					onComplete: function () {
						$(toaster).remove()
		...
		ripple = function (e, el) {
			if ($(".no-svg").length) return !1;
			var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
				g = document.createElementNS("http://www.w3.org/2000/svg", "g"),
				circle = document.createElementNS("http://www.w3.org/2000/svg", "circle"),
				x = e.offsetX,
				y = e.offsetY;
			if (void 0 == x || void 0 == y) return !1;
			svg.setAttributeNS(null, "class", "ripple ripple" + inc), g.setAttributeNS(null, "transform", "translate(" + x + ", " + y + ")"), circle.setAttributeNS(null, "r", parseInt(el.outerWidth()) + x), svg.appendChild(g), g.appendChild(circle), el.append(svg);
...
var RR = function (parent, $) {
	...
	function backgroundResize() {
		vw = $window.outerWidth(), vh = $window.outerHeight(), $headerWrap.css({
			width: vw + "px",
			height: vh + "px"
		})
	}
	var vh, vw, tlHover, $document = $(document),
		$window = $(window),
		...
		setup = function () {
			var tlClick = new TimelineMax,
				...
				bl = ".box.bl",
				br = ".box.br";
			tlHover = new TimelineMax, tlClick.to(tl, .25, {
				backgroundColor: "#fff",
				left: 0,
				top: 0,
				ease: Expo.easeOut
				...
				top: 0,
				ease: Expo.easeOut
			}, "-=0.25"), tlClick.to(bl, .25, {
				backgroundColor: "#fff",
				left: 0,
				bottom: 0,
				ease: Expo.easeOut
			}, "-=0.25"), tlClick.to(br, .25, {
				backgroundColor: "#fff",
				right: 0,
				bottom: 0,
				ease: Expo.easeOut
			}, "-=0.25"), tlClick.to(tl, .25, {
				height: 30,
				rotation: 45,
				ease: Expo.easeOut
			}), tlClick.to(tr, .25, {
				...
				autoAlpha: 0,
				ease: Expo.easeOut
			}, "-=0.25"), tlClick.pause(), tlClick.eventCallback("onReverseComplete", function () {
				setTimeout(function () {
					$(".menu .box").attr("style", "")
				}, 200)
			}), tlHover.to(tl, .2, {
				...
				bottom: -20,
				ease: Expo.easeOut
			}, "-=0.2"), tlHover.pause(), $menu.on("click", function (e) {
				e.preventDefault();
				var $this = $(this);
				$this.toggleClass("active"), $primaryNav.toggleClass("active"), $headerWrap.toggleClass("active"), $this.hasClass("active") ? (tlClick.play(), $primaryNav.find("ul").css({
					height: $window.height() - parseInt($primaryNav.find("ul").css("margin-top"))
				})) : ($primaryNav.find("ul").css({
					height: "auto"
				}), tlClick.reverse())
			}).on("mouseover", function () {
				!$(this).hasClass("active") && $(".no-touchevents").length && tlHover.play()
			}).on("mouseout", function () {
				!$(this).hasClass("active") && $(".no-touchevents").length && tlHover.reverse()
			}), $primaryNav.append('<i class="overlay"></i>').on("click", ".overlay", function (e) {
				e.preventDefault(), $menu.trigger("click")
			}), vw = $document.outerWidth(), vh = $document.outerHeight(), backgroundResize(), $window.on("resize scroll", debounce(function () {
				backgroundResize()
			}, 250))
		},
		tlHoverReverse = function () {
			tlHover.reverse()
		};
	return parent.menu = {
		setup: setup,
	...
	function ($, undefined) {
		...
		$(function () {
			TweenMax.ticker.fps(60),
				function () {
					Modernizr.backgroundsize || $(".backstretch").each(function () {
						var $this = $(this),
				...
				function () {
					Modernizr.objectfit || setTimeout(function () {
						$(".card-wrap").each(function () {
							var $this = $(this),
								$img = ($this.parent(), $this.find("img"));
							$this.css({
